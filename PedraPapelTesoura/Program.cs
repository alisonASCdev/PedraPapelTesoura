...
class Program
{
    ...
    public static void defineRodadas()
    {
        ...
        desenhaCabecalho(3);
        Console.WriteLine("Quantas rodadas vocé quer jogar? 3, 5 ou 7?");
        ...
        while (rodadas != 3 && rodadas != 5 && rodadas != 7)
        {
            ...
            Console.WriteLine("Vocé digitou um valor Inválido!!. Escolha entre os números 3, 5 ou 7: ");
            rodadas = Int32.Parse(Console.ReadLine());
    ...
    public static void controlaRodadas()
    {
        ...
        while (fimDeJogo != true)
        {
            ...
            if (fimDeJogo == true)
            {
                ...
                {
                    Console.WriteLine("Parabéns!! vocé venceu");
                }
                else
                {
                    Console.WriteLine("Vocé perdeu :( ");
                }
                Console.WriteLine("\n\n");
